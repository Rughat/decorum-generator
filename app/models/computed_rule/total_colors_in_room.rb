  ...
  class TotalColorsInRoom < Requirement
    ...
    def self.build(house:, sections: Section, feature:)
      ...
      rule.text = case max_colors
                  ...
                  when 3
                    "There must not be any room with all four colors in the house (as objects and/or wall color)"
                  when 2
                    "There must not be more than two different colors in any room (as objects and/or wall color)"
                  else
